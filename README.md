...
See [enabled_ttl.proto](https://github.com/Galaxyobe/protoc-gen-redis/blob/master/examples/enabled_ttl.proto)
```protobuffer
syntax = "proto3";
package test;
...
```
See [enabled_ttl.redis.go](https://github.com/Galaxyobe/protoc-gen-redis/blob/master/examples/enabled_ttl.redis.go)
```golang
